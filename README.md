🚀 Este é um projeto simples em PHP que utiliza a biblioteca `fakerphp/faker` para gerar dados falsos. A aplicação gera um nome, email e endereço aleatórios e os exibe em uma página web.
